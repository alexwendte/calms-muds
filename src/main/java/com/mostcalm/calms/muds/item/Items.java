...
public class Items {
  ...
  static {
    MUDBALL = register("mudball", (Item) (new MudballItem(
        new Item.Settings().group(ItemGroup.MISC).maxCount(16))));
    DRIED_MUDBALL = register("dried_mudball",
        (Item) (new DriedMudBallItem(new Item.Settings().group(ItemGroup.FOOD)
            .food(MudFoodComponents.DRIED_MUDBALL)
            .maxCount(16))));
